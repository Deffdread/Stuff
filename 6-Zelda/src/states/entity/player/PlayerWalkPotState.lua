...
function PlayerWalkPotState:enter(def)
    self.pot = def.pot
end
...
function PlayerWalkPotState:update(dt)
    if love.keyboard.isDown('left') then
        ...
        self.entity:changeAnimation('pot-walk-left',{pot = self.pot})
    elseif love.keyboard.isDown('right') then
        self.entity.direction = 'right'
        self.entity:changeAnimation('pot-walk-right',{pot = self.pot})
    elseif love.keyboard.isDown('up') then
        self.entity.direction = 'up'
        self.entity:changeAnimation('pot-walk-up',{pot = self.pot})
    elseif love.keyboard.isDown('down') then
        self.entity.direction = 'down'
        self.entity:changeAnimation('pot-walk-down',{pot = self.pot})
    else
