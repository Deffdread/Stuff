...
function AlienLaunchMarker:update(dt)
    ...
    if self.launched and love.keyboard.wasPressed('space') and self.split == false then

        local x, y = self.alien.body:getLinearVelocity()

        --Upper Alien
        local alien1 = Alien(self.world, 'round', self.alien.body:getX(), self.alien.body:getY(), 'Player')
        alien1.body:setLinearVelocity(x, y-20)
        ...
        --Lower Alien
        local alien2 = Alien(self.world, 'round', self.alien.body:getX(), self.alien.body:getY(), 'Player')
        alien2.body:setLinearVelocity(x,y+20)
